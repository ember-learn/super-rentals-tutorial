In the [previous chapter](../02-adding-pages), we put a lot of effort into crafting some beautiful pages. We should make sure our customers can find them! The way we do that on the web is by using *[hyperlinks](TODO: link to hyperlinks)*, or *links* for short.
